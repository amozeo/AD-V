...
export const general = {
  ...
  glitchChallengePI: {
    ...
    multValue: (gc, dim) => preInfinityUG(gc).effectOrDefault(1),
  ...
  glitchChallengeBI: {
    name: gc => `Glitch Challenge ${gc + 1}`,
    multValue: (gc, dim) => breakInfinityUG(gc).effectOrDefault(1),
  ...
  glitchChallengeEternity: {
    name: gc => `Glitch Challenge ${gc + 1}`,
    multValue: (gc, dim) => eternityUG(gc).effectOrDefault(1),
  ...
  glitchChallengeReality: {
    name: gc => `Glitch Challenge ${gc + 1}`,
    multValue: (gc, dim) => realityUG(gc).effectOrDefault(1),
  ...
  glitchUpgrades: {
    ...
    multValue: (gu, dim) => GlitchRealityUpgrade(gu).effectOrDefault(1),
